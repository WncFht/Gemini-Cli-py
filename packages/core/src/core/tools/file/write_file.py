"""
This file is refactored from packages/core_ts/src/tools/write-file.ts.
"""
...
from ...utils.edit_corrector import ensure_correct_file_content
...
from ..common import ToolEditConfirmationDetails
