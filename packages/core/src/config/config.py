...
from ..core.app import GeminiClient
from ..services.file_discovery import FileDiscoveryService
from ..services.git_service import GitService
from ..tools.base.registry import ToolRegistry
from .models import DEFAULT_GEMINI_EMBEDDING_MODEL, DEFAULT_GEMINI_MODEL
...
def create_tool_registry(config: Settings) -> ToolRegistry:
    ...
    from ..tools.file.edit_file import EditTool
    ...
    from ..tools.web.web_fetch import WebFetchTool
